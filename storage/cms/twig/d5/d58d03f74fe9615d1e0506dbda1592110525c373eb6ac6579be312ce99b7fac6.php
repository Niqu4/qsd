...
/* C:\xampp\htdocs\qsd/themes/zwiebl-zwiebl_stellar/pages/almaty.htm */
class __TwigTemplate_2e9c2047e3b788b31c2ad70e152a3a35a6d46804a15d9a12a268d28b68ab722f extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo "<script src=\"https://maps.api.2gis.ru/2.0/loader.js?pkg=full\"></script>
            <script type=\"text/javascript\">
                ...
                DG.then(function () {
                    map = DG.map('map', {
                        center: [43.274265, 76.927588],
                        zoom: 17
                    });
    
                    DG.marker([43.274265, 76.927588]).addTo(map).bindPopup('KZQSD, офис в г. Алматы');
                });
    </script>
    <h2> Мы на карте: </h2>
    <h4><a  class=\"hvr-sweep-to-top\" href=\"https://go.2gis.com/c2vbn\" target=\"_blank\"> ул. Новгородская 172/2</h4> </a>
...
<thead><tr><th>Город-получатель</th><th>\"Дверь-Дверь\", тнг</th><th>\"Склад-Дверь\", тнг</th><th>\"Склад-Склад\", тнг</th></tr></thead><tbody>
 ...
 <tr><td>Кентау</td><td>2200</td><td>1900</td><td>&nbsp;</td></tr>
 ...
 <tr><td>Шымкент</td><td>2000</td><td>1700</td><td>1400</td></tr>
...
<iframe src=\"https://home.courierexe.ru/108/calculator\" title=\"Тарифный калькулятор\">
    ...
    {
        return "C:\\xampp\\htdocs\\qsd/themes/zwiebl-zwiebl_stellar/pages/almaty.htm";
    }
...
<h2> Для более точного расчета стоимости доставки, воспользуйтесь тарифным калькулятором: </h2>
<iframe src=\"https://home.courierexe.ru/108/calculator\" title=\"Тарифный калькулятор\">
</iframe>", "C:\\xampp\\htdocs\\qsd/themes/zwiebl-zwiebl_stellar/pages/almaty.htm", "");
    }
}
