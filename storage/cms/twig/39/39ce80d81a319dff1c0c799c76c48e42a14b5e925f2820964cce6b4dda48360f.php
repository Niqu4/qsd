...
/* C:\xampp\htdocs\qsd/themes/zwiebl-zwiebl_stellar/pages/uralsk.htm */
class __TwigTemplate_3b81a9558a8b8d84dca879c6ad39036c4c7572c38840d62af0e8b471d97bb1e5 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <script type=\"text/javascript\">
        ...
        DG.then(function () {
            map = DG.map('map', {
                center: [51.241468, 51.408232],
                zoom: 17
            });

            DG.marker([51.241468, 51.408232]).addTo(map).bindPopup('KZQSD, офис в г. ";
        // line 11
    ...
    <h2> Мы на карте: </h2>
    <h4><a  class=\"hvr-sweep-to-top\" href=\"https://go.2gis.com/vgj9ve\" target=\"_blank\"> мкр. Ульяны Громовой 27/1</h4> </a>
...
<thead><tr><th>Город-получатель</th><th>\"Дверь-Дверь\", тнг</th><th>\"Склад-Дверь\", тнг</th><th>\"Склад-Склад\", тнг</th></tr></thead><tbody>
 <tr><td>Аксай</td><td>2000</td><td>1700</td><td>&nbsp;</td></tr>
...
<iframe src=\"https://home.courierexe.ru/108/calculator\" title=\"Тарифный калькулятор\">
    ...
    {
        return "C:\\xampp\\htdocs\\qsd/themes/zwiebl-zwiebl_stellar/pages/uralsk.htm";
    }
    ...
    <script type=\"text/javascript\">
        ...
        DG.then(function () {
            ...
            DG.marker([51.241468, 51.408232]).addTo(map).bindPopup('KZQSD, офис в г. {{ this.page.title }}');
        });
    </script>
    <h2> Мы на карте: </h2>
    <h4><a  class=\"hvr-sweep-to-top\" href=\"https://go.2gis.com/vgj9ve\" target=\"_blank\"> мкр. Ульяны Громовой 27/1</h4> </a>
...
<h2> Для более точного расчета стоимости доставки, воспользуйтесь тарифным калькулятором: </h2>
<iframe src=\"https://home.courierexe.ru/108/calculator\" title=\"Тарифный калькулятор\">
</iframe>", "C:\\xampp\\htdocs\\qsd/themes/zwiebl-zwiebl_stellar/pages/uralsk.htm", "");
    }
}
