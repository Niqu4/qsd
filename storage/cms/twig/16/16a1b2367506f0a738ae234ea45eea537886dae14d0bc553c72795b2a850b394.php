...
/* C:\xampp\htdocs\qsd/themes/zwiebl-zwiebl_stellar/pages/atyrau.htm */
class __TwigTemplate_358760b686c92a20e0aa46efc5bd02d4dd8c681d3e7d7dfb0a49a2f3cde9c1b8 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo "<script src=\"https://maps.api.2gis.ru/2.0/loader.js?pkg=full\"></script>
            <script type=\"text/javascript\">
                ...
                DG.then(function () {
                    map = DG.map('map', {
                        center: [47.116605, 51.882393],
                        zoom: 17
                    });
    
                    DG.marker([47.116605, 51.882393]).addTo(map).bindPopup('KZQSD, офис в г. ";
        // line 11
    ...
    <h2> Мы на карте: </h2>
    <h4><a  class=\"hvr-sweep-to-top\" href=\"https://go.2gis.com/bjc2ol\" target=\"_blank\"> ул. Бегельдинова 49</h4> </a>
...
<thead><tr><th>Город-получатель</th><th>\"Дверь-Дверь\", тнг</th><th>\"Склад-Дверь\", тнг</th><th>\"Склад-Склад\", тнг</th></tr></thead><tbody>
 ...
 <tr><td>Кульсары</td><td>2000</td><td>1700</td><td>&nbsp;</td></tr>
...
<iframe src=\"https://home.courierexe.ru/108/calculator\" title=\"Тарифный калькулятор\">
    ...
    {
        return "C:\\xampp\\htdocs\\qsd/themes/zwiebl-zwiebl_stellar/pages/atyrau.htm";
    }
        ...
        return new Source("<script src=\"https://maps.api.2gis.ru/2.0/loader.js?pkg=full\"></script>
            <script type=\"text/javascript\">
                ...
                DG.then(function () {
                    ...
                    DG.marker([47.116605, 51.882393]).addTo(map).bindPopup('KZQSD, офис в г. {{ this.page.title }}');
                });
    </script>
    <h2> Мы на карте: </h2>
    <h4><a  class=\"hvr-sweep-to-top\" href=\"https://go.2gis.com/bjc2ol\" target=\"_blank\"> ул. Бегельдинова 49</h4> </a>
...
<h2> Для более точного расчета стоимости доставки, воспользуйтесь тарифным калькулятором: </h2>
<iframe src=\"https://home.courierexe.ru/108/calculator\" title=\"Тарифный калькулятор\">
</iframe>", "C:\\xampp\\htdocs\\qsd/themes/zwiebl-zwiebl_stellar/pages/atyrau.htm", "");
    }
}
