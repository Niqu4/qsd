...
/* C:\xampp\htdocs\qsd/themes/zwiebl-zwiebl_stellar/pages/aktau.htm */
class __TwigTemplate_6eba18b3169fdc9527817ed39d1258cae758438f165d6e7aa4e78cfd5b6e4e6e extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <script type=\"text/javascript\">
        ...
        DG.then(function () {
            map = DG.map('map', {
                center: [43.644287, 51.161132],
                zoom: 17
            });

            DG.marker([43.644287, 51.161132]).addTo(map).bindPopup('KZQSD, офис в г. ";
        // line 11
    ...
    <h2> Мы на карте: </h2>
    <h4><a  class=\"hvr-sweep-to-top\" href=\"https://go.2gis.com/mdd93\" target=\"_blank\"> 8 мкр, 39А \"БЦ Альянс Элит\"</h4> </a>
...
<thead><tr><th>Город-получатель</th><th>\"Дверь-Дверь\", тнг</th><th>\"Склад-Дверь\", тнг</th><th>\"Склад-Склад\", тнг</th></tr></thead><tbody>
 ...
 <tr><td>Бейнеу</td><td>2000</td><td>1700</td><td>&nbsp;</td></tr>
 <tr><td>Жанаозен</td><td>2000</td><td>1700</td><td>&nbsp;</td></tr>
...
<iframe src=\"https://home.courierexe.ru/108/calculator\" title=\"Тарифный калькулятор\">";
    ...
    {
        return "C:\\xampp\\htdocs\\qsd/themes/zwiebl-zwiebl_stellar/pages/aktau.htm";
    }
    ...
    <script type=\"text/javascript\">
        ...
        DG.then(function () {
            ...
            DG.marker([43.644287, 51.161132]).addTo(map).bindPopup('KZQSD, офис в г. {{ this.page.title }}');
        });
    </script>
    <h2> Мы на карте: </h2>
    <h4><a  class=\"hvr-sweep-to-top\" href=\"https://go.2gis.com/mdd93\" target=\"_blank\"> 8 мкр, 39А \"БЦ Альянс Элит\"</h4> </a>
...
<h2> Для более точного расчета стоимости доставки, воспользуйтесь тарифным калькулятором: </h2>
<iframe src=\"https://home.courierexe.ru/108/calculator\" title=\"Тарифный калькулятор\">", "C:\\xampp\\htdocs\\qsd/themes/zwiebl-zwiebl_stellar/pages/aktau.htm", "");
    }
}
