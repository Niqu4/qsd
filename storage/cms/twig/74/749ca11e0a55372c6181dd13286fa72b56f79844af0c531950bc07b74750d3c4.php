...
/* C:\xampp\htdocs\qsd/themes/zwiebl-zwiebl_stellar/pages/karaganda.htm */
class __TwigTemplate_db26cc2dc9f1e5446b4d953e500fd3e9fda3d2d7b6aa4e8fc37a299c79721835 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <script type=\"text/javascript\">
        ...
        DG.then(function () {
            map = DG.map('map', {
                center: [49.81563, 73.086138],
                zoom: 17
            });

            DG.marker([49.81563, 73.086138]).addTo(map).bindPopup('KZQSD, офис в г. ";
        // line 11
    ...
    <h2> Мы на карте: </h2>
    <h4><a  class=\"hvr-sweep-to-top\" href=\"https://go.2gis.com/a2gz1\" target=\"_blank\">ул. Ерубаева ул 20, офис 224</h4> </a>
...
<thead><tr><th>Город-получатель</th><th>\"Дверь-Дверь\", тнг</th><th>\"Склад-Дверь\", тнг</th><th>\"Склад-Склад\", тнг</th></tr></thead><tbody>
 ...
 <tr><td>Балхаш</td><td>2000</td><td>1700</td><td>&nbsp;</td></tr>
 <tr><td>Бейнеу</td><td>2800</td><td>&nbsp;</td><td>&nbsp;</td></tr>
 <tr><td>Жанаозен</td><td>2800</td><td>&nbsp;</td><td>&nbsp;</td></tr>
 <tr><td>Жезказган</td><td>2000</td><td>1700</td><td>&nbsp;</td></tr>
 ...
 <tr><td>Темиртау</td><td>2000</td><td>1700</td><td>&nbsp;</td></tr>
...
<iframe src=\"https://home.courierexe.ru/108/calculator\" title=\"Тарифный калькулятор\">
    ...
    {
        return "C:\\xampp\\htdocs\\qsd/themes/zwiebl-zwiebl_stellar/pages/karaganda.htm";
    }
    ...
    <script type=\"text/javascript\">
        ...
        DG.then(function () {
            ...
            DG.marker([49.81563, 73.086138]).addTo(map).bindPopup('KZQSD, офис в г. {{ this.page.title }}');
        });
    </script>
    <h2> Мы на карте: </h2>
    <h4><a  class=\"hvr-sweep-to-top\" href=\"https://go.2gis.com/a2gz1\" target=\"_blank\">ул. Ерубаева ул 20, офис 224</h4> </a>
...
<h2> Для более точного расчета стоимости доставки, воспользуйтесь тарифным калькулятором: </h2>
<iframe src=\"https://home.courierexe.ru/108/calculator\" title=\"Тарифный калькулятор\">
</iframe>", "C:\\xampp\\htdocs\\qsd/themes/zwiebl-zwiebl_stellar/pages/karaganda.htm", "");
    }
}
