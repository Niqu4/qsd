...
/* C:\xampp\htdocs\qsd/themes/zwiebl-zwiebl_stellar/pages/kostanay.htm */
class __TwigTemplate_55abd2bd073bfef767f4c4a28fdcddd7058b45f055dee9d3f4d7e7ed5744e82e extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <script type=\"text/javascript\">
        ...
        DG.then(function () {
            map = DG.map('map', {
                center: [53.224714, 63.604085],
                zoom: 17
            });

            DG.marker([53.224714, 63.604085]).addTo(map).bindPopup('KZQSD, офис в г. ";
        // line 11
    ...
    <h2> Мы на карте: </h2>
    <h4><a  class=\"hvr-sweep-to-top\" href=\"https://go.2gis.com/bx0l9\" target=\"_blank\"> ул. Аль-Фараби 141/10 </h4> </a>
...
<thead><tr><th>Город-получатель</th><th>\"Дверь-Дверь\", тнг</th><th>\"Склад-Дверь\", тнг</th><th>\"Склад-Склад\", тнг</th></tr></thead><tbody>
 ...
 <tr><td>Алматы</td><td>2200</td><td>1900</td><td>1600</td></tr>
 ...
 <tr><td>Рудный</td><td>2000</td><td>1700</td><td>&nbsp;</td></tr>
...
<iframe src=\"https://home.courierexe.ru/108/calculator\" title=\"Тарифный калькулятор\">
    ...
    {
        return "C:\\xampp\\htdocs\\qsd/themes/zwiebl-zwiebl_stellar/pages/kostanay.htm";
    }
    ...
    <script type=\"text/javascript\">
        ...
        DG.then(function () {
            ...
            DG.marker([53.224714, 63.604085]).addTo(map).bindPopup('KZQSD, офис в г. {{ this.page.title }}');
        });
    </script>
    <h2> Мы на карте: </h2>
    <h4><a  class=\"hvr-sweep-to-top\" href=\"https://go.2gis.com/bx0l9\" target=\"_blank\"> ул. Аль-Фараби 141/10 </h4> </a>
...
<h2> Для более точного расчета стоимости доставки, воспользуйтесь тарифным калькулятором: </h2>
<iframe src=\"https://home.courierexe.ru/108/calculator\" title=\"Тарифный калькулятор\">
</iframe>", "C:\\xampp\\htdocs\\qsd/themes/zwiebl-zwiebl_stellar/pages/kostanay.htm", "");
    }
}
